...
namespace gazebo
{
  ...
  class SonarROSPlugin : public ROSBaseModelPlugin
  {
    ...
    protected: void OnBeamCallback(const sensor_msgs::msg::Range::ConstSharedPtr& _range);
    ...
    protected: uuv_sensor_ros_plugins_msgs::msg::DVLBeam dvlBeamMsg;
    ...
    protected: std::string beamsLinkName;

    /// \brief List of beam topics
    protected: std::string beamTopic;

    /// \brief List of poses of each beam wrt to the DVL frame
    protected: ignition::math::Pose3d beamPoses;
    ...
    protected: rclcpp::Publisher<uuv_sensor_ros_plugins_msgs::msg::MSIS>::SharedPtr rosSensorOutputPub;
