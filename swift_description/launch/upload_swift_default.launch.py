...
def launch_setup(context, *args, **kwargs): 
    ...
    # Xacro
    #xacro_file = PathJoinSubstitution(get_package_share_directory('uuv_descriptions'),'robots','swift_')
    xacro_file = os.path.join(
        get_package_share_directory('swift_description'),
        'robots',
        'swift_' + (Lc('mode')).perform(context) + '.xacro'
    )
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('namespace', default_value='swift'),
